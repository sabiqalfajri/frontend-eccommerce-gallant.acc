...
export const VerifyEmail = () => {
    ...
    return (
        <form action="" onSubmit={onSubmit}>
            <div className={`flex flex-col items-center justify-center h-screen bg-gray-100 ${isSubmitting ? 'pointer-events-none opacity-50' : ''}`}>
                ...
                <div className="flex flex-col items-center justify-center gap-2 mt-[1.5rem]"> 
                    <Button className="w-[350px]" variant="primary" type="submit" disabled={!isOtpComplete || isSubmitting}>
