            ...
            <div className="grid grid-cols-1 md:grid-cols-[30%_70%] gap-12 mb-12">
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-wrap justify-start items-center gap-3 mt-1">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="size-6" fill="#FFFFFF" viewBox="0 0 24 24">
                            <path d="M22.46 6a8.4 8.4 0 0 1-2.36.65 4.1 4.1 0 0 0 1.8-2.28 8.3 8.3 0 0 1-2.6 1 4.2 4.2 0 0 0-7.2 3.8A12 12 0 0 1 3 4.2a4.2 4.2 0 0 0 1.3 5.6 4.2 4.2 0 0 1-1.9-.5v.05a4.2 4.2 0 0 0 3.4 4.1 4.2 4.2 0 0 1-1.9.07 4.2 4.2 0 0 0 3.9 2.9 8.5 8.5 0 0 1-5.3 1.8A8.2 8.2 0 0 1 2 18.5a12 12 0 0 0 6.4 1.9c7.7 0 12-6.4 12-12V8a8.4 8.4 0 0 0 2-2.1z"/>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" className="size-6" fill="#FFFFFF" viewBox="0 0 50 50">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-16">
                    <div className="flex flex-col gap-5">
                        ...
                        <ul className="flex flex-col gap-3 text-sm">
                            <li className="hover:font-bold transform transition-all duration-300">
                                <a href="">Home</a>  
                            </li>
                            <li className="hover:font-bold transform transition-all duration-300">
                                <a href="">Shop</a>  
